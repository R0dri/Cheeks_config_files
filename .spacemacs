...
(load "visual-basic-mode") ;; best not to include the ending “.el” or “.elc”
;; setup files ending in “.js” to open in js2-mode
;;(add-to-list 'auto-mode-alist '("\\.js\\'" . js2-mode))
(add-to-list 'auto-mode-alist '("\\.vb\\'" . visual-basic-mode))
(add-to-list 'auto-mode-alist '("\\aspx.vb\\'" . visual-basic-mode))
...
values."
  ...
  ;; dotspacemacs-configuration-layer-path '("~/.emacs.d/lisp/")
   ...
   ;;dotspacemacs-additional-packages '(visual-basic-mode)
...
values."
  ...
  ;; Tell emacs where is your personal elisp lib dir
    ;;(setq-default omnisharp-server-executable-path "~/omnisharp-server/OmniSharp")
  ;;(setq-default omnisharp-server-executable-path "~/OMNISHARP/OmniSharpServer")
...
you should place your code here."
  ...
  ;;(define-key evil-window-map (kbd "l") 'evil-window-left)
  ;;(define-key evil-window-map (kbd "j") 'evil-window-down)
  ;;(define-key evil-window-map (kbd "k") 'evil-window-up)
  ;;(define-key evil-window-map (kbd ";") 'evil-window-right)
  ...
  ;;(use-package ivy_buffer_extend :load-path "~/.emacs.d/lisp/ivy_buffer_extend.el")
    ...
    (if (display-graphic-p)
      ...
      (if (region-active-p)
          (progn
            ...
            (shell-command-on-region (region-beginning) (region-end) "pbcopy -i -b")
  ...
  (defun paste-from-clipboard ()
    ...
    (if (display-graphic-p)
      ...
      (insert (shell-command-to-string "pbpaste -o -b"))
      )
    )
...
(defun th-shell-popup ()
  ...
  (unless (buffer-live-p th-shell-popup-buffer)
    (save-window-excursion (eshell "*Popup Shell*"))
...
(custom-set-variables
 ...
 '(eshell-output-filter-functions
   (quote
    (eshell-truncate-buffer eshell-handle-control-codes eshell-handle-ansi-color eshell-watch-for-password-prompt)))
 '(package-selected-packages
   (quote
    (ztree org-projectile org-present org org-pomodoro alert log4e gntp org-download htmlize gnuplot helm-css-scss helm-company helm-c-yasnippet helm-themes helm-swoop helm-projectile helm-mode-manager helm-flx helm-descbinds helm-ag ace-jump-helm-line xterm-color ws-butler window-numbering which-key wgrep web-mode web-beautify volatile-highlights vimrc-mode vi-tilde-fringe uuidgen use-package toc-org tagedit sql-indent spacemacs-theme spaceline smex slim-mode shell-pop scss-mode sass-mode restart-emacs request rainbow-delimiters quelpa pug-mode popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file omnisharp neotree multi-term move-text mmm-mode markdown-toc macrostep lorem-ipsum livid-mode linum-relative link-hint less-css-mode json-mode js2-refactor js-doc ivy-hydra info+ indent-guide ido-vertical-mode hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-make google-translate golden-ratio gh-md flx-ido fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-surround evil-search-highlight-persist evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state evil-exchange evil-escape evil-ediff evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help emmet-mode elisp-slime-nav dumb-jump define-word dactyl-mode counsel-projectile company-web company-tern company-statistics company-auctex column-enforce-mode coffee-mode clean-aindent-mode auto-yasnippet auto-highlight-symbol auto-compile aggressive-indent adaptive-wrap ace-window ace-link ac-ispell)))
